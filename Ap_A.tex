...
\lstinputlisting[style = MATLAB, caption = Generar lookup table, label = cod:D1_Look_up_table]{codigos/D1_Look_up_table.m}

\lstinputlisting[style = MATLAB, caption = Simulación spice pasabajas, label = cod:LTspice_simulacion]{LTspice_simulacion/pasabajas.cir}
...
\lstinputlisting[style = MATLAB, caption = C10\_{}calculo\_{}valores\_{}FilterBiquad, label = cod:C10_calculo_valores_FilterBiquad]{codigos/C10_calculo_valores_FilterBiquad.m}

\lstinputlisting[style = MATLAB, caption = Función saturación, label = cod:saturation_cust]{codigos/saturation_cust.m}
